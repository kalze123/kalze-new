...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝    ╚═╝  ╚═╝╚═════╝ 
   ...
   \033[44m\033[1;37m Informasi Script  \033[41m\033[1;37m Newbie V 2.0 \x1b[0m\n
 Author   : {P}Kalzeee xd{Q}
 Coded    : {P}CODE CR4CKERS{Q}
 Whatsapp : +6283865283286
 Facebook : KALZE ({II}Kang Encryption{Q})
 Github   : https://github.com/Kalze-brute
 """)
...
class crackmenu:
	...
	def menu_crack(self):   # METHOD AUTO PASSWROD
		...
		print(Q+" |-->4. Mbasic V1 ("+II+"Recommended V1"+Q+")         |");time.sleep(0.02)
